...
The application supports [FEN Notation](https://en.wikipedia.org/wiki/Forsyth%E2%80%93Edwards_Notation) which allows to load custom positions. Interactions with the engine can be performed through CLI or GUI.

The IA was tested against other chess engines and can win some games against ~1500 elo IA.
